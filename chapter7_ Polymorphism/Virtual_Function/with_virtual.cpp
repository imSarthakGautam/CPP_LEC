// When a function is made virtual it allows a program to decide at  
// BASED ON THE TYPE OF THE BOJECT POINTED BY THE POINTER rather than TYPe OF THE POINTER itself
#include <iostream>
using namespace std;
